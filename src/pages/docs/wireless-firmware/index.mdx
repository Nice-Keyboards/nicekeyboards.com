...
description: Overview of wireless keyboard firmwares
order: 2
---

# Wireless Keyboard Firmware

Firmware is an extremely important part of a keyboard. Custom wireless keyboards are still in infancy, so firmwares (while very much usable!) are still heavily being worked on. You may be wondering "why isn't it supported in QMK?". You can read why [here](/docs/nice-nano/faq/#qmk-firmware-support).


## Options

- ### [ZMK](/docs/wireless-firmware/zmk) - Recommended
...
- ### [BlueMicro](/docs/wireless-firmware/bluemicro) - Recommended
