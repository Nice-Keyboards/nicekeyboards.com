...
## Required Parts
 ...
 - 4x2U, 1x62.5U Stabilizers
 - 3.7V Lithium Rechargeable Battery
   - At Least 500mAh
   - 2-Pin JST-PH (2.00mm) Connector
 - 60% Case (Standard GH60/DZ60 Style)
   - Keep in mind that a big metal cage is not cohesive with wireless connections
...
> Build stream coming soon. In the mean time, here's a build video using a different wired hotswap PCB: https://www.youtube.com/watch?v=deVaUvywGMw

## Default Keymap

The nice!60 is preloaded with the ZMK firmware using the below keymap. Read more about [ZMK here](https://zmkfirmware.dev).

![Default Keymap](../_images/nice60_keymap.png)

## Managing Wireless Profiles

Check out the [ZMK docs](https://zmkfirmware.dev/docs/behaviors/bluetooth) on how the wireless BLE works.
...
![Step 8](../_images/nice60-custom-firmware-step8.png)
 9. Edit the keymap as wanted. Use the [ZMK codes docs](https://zmkfirmware.dev/docs/codes/) to find standard HID input options you have for your keymap and check the [Behaviors category](https://zmkfirmware.dev/docs) on the left to find other ZMK specific behaviors.
