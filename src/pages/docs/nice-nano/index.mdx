...
The nice!nano uses the [Adafruit nRF52 Bootloader](https://github.com/adafruit/Adafruit_nRF52_Bootloader). Currently it doesn't have a release of the nice!nano bootloader yet, so please use this one I've generated and put on every nice!nano thus far. [Click here to download](/assets/nicenano_bootloader_v1.hex).
