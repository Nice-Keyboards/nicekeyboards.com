...
2. Download the [DFU pkg of the nice!nano bootloader](/assets/nice_nano_bootloader-0.6.0_s140_6.1.1).
3. Connect your nice!nano and put it into the bootloader using a double-tap reset.
4. Run the following command in your terminal:

```shell
adafruit-nrfutil --verbose dfu serial --package nice_nano_bootloader-0.6.0_s140_6.1.1 -p SERIALPORT -b 115200 --singlebank --touch 1200
```
