...
description: Troubleshooting tips for the nice!nano
order: 3
---
...
Before doing this, you should exhaust all other options, as attempting to flash the bootloader has the potential to brick your nice!nano if done incorrectly!
...
2. Download the [DFU pkg of the nice!nano bootloader](/assets/nice_nano_bootloader-0.6.0_s140_6.1.1.zip).
...
This is the preffered device as it allows access to write protected parts of the nRF MCU, that the cheaper options do not always allow.

1. Plug in your nice!nano over USB
2. Connect these 4 pins to the nice!nano (use the [pinout](/docs/nice-nano/pinout-schematic) as reference)
...
3. Download the [bootloader hex](/assets/nice_nano_bootloader-0.6.0_s140_6.1.1.hex)
...
1. Plug in your nice!nano over USB
2. Connect these 2 pins to the nice!nano (use the [pinout](/docs/nice-nano/pinout-schematic) as reference)
