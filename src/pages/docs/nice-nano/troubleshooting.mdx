...
2. Download the [DFU pkg of the nice!nano bootloader](/assets/nice_nano_bootloader-_s140_6.1.1.zip).
...
3. Download the [bootloader hex](/assets/nicenano_bootloader_v1.hex)
