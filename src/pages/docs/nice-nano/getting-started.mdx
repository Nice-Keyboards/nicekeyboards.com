...
description: A quick guide on how to get started with your nice!nano
order: 1
---
...
Now you may be wondering how to get one of these mystical .uf2 files. You get them by building one of the firmwares available. Checkout the [**Wireless Firmware**](/docs/wireless-firmware/) page to get information on how to configure and build a few different types of firmwares along with some recommendations.
